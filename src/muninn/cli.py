...
@click.command()
@click.option("--path", type=click.Path(exists=True, path_type=Path), help="Direct path to team directory")
@click.option("--team", type=str, help="Team name to look up in teams directory")
@click.option("--teams-dir", type=click.Path(path_type=Path), default=None, help="Override teams directory (default: ~/.claude/teams)")
